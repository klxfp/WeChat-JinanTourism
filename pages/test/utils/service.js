    ...
    return function() {
        ...
        return new Promise(function(resolve, reject) {
            ...
            var headers = Object.assign({
                ...
                ElongReferer: currentPage ? currentPage.__route__ : ""
            }, config.headers || {});
            ...
            if (config.mockData) {
                ...
                function formReqParamData(url, params) {
                    var newParams = url.indexOf("authorize/")>=0 || url.indexOf("hotelwxxcx/")>=0?params:{"req":JSON.stringify(params)}
                    return newParams
                }
                function request(onComplete) {
                    ...
                    api.request({
                        url: config.url,
                        data: formReqParamData(config.url, params),
                        header: headers,
                        method: method,
                        ...
                        complete: function(result) {
                            __wxConfig.debug && console.log('request >>  url = ', config.url, ',request Data = ', params, ' , result = ', result);
                            config.noLoading || setTimeout(function() {
